...
extern ClassDesc2* GetMaxExportPluginDesc();
...
// This function returns a string that describes the DLL and where the user could purchase the DLL if they don't have it.
__declspec (dllexport) const TCHAR* LibDescription()
{
	return GetString(IDS_LIBDESCRIPTION);
}

// This function returns the number of plug-in classes this DLL. Must change this number when adding a new class
