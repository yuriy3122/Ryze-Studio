...
*/
   ...
   */
	...
	{
        static_cast<void>(m_floats[0] = _x), static_cast<void>(m_floats[1] = _y), static_cast<void>(m_floats[2] = _z), m_floats[3] = 0.0f;
	}
   ...
   */
	...
	{
        static_cast<void>(m_floats[0] = _x), static_cast<void>(m_floats[1] = _y), static_cast<void>(m_floats[2] = _z), m_floats[3] = _w;
	}
