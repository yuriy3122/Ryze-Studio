...
btMiniSDF::shape_function_(btVector3 const& xi, btShapeGradients* gradient) const
{
	...
	if (gradient)
	{
        ...
        static_cast<void>(dN(8, 0) = _m3m9x2m2x * _1myt1mz),
        static_cast<void>(dN(8, 1) = -_1mx2t1m3x * _1mz),
			  dN(8, 2) = -_1mx2t1m3x * _1my;
        static_cast<void>(dN(9, 0) = _p3m9x2m2x * _1myt1mz),
        static_cast<void>(dN(9, 1) = -_1mx2t1p3x * _1mz),
			  dN(9, 2) = -_1mx2t1p3x * _1my;
        static_cast<void>(dN(10, 0) = _m3m9x2m2x * _1myt1pz),
        static_cast<void>(dN(10, 1) = -_1mx2t1m3x * _1pz),
			   dN(10, 2) = _1mx2t1m3x * _1my;
        static_cast<void>(dN(11, 0) = _p3m9x2m2x * _1myt1pz),
        static_cast<void>(dN(11, 1) = -_1mx2t1p3x * _1pz),
			   dN(11, 2) = _1mx2t1p3x * _1my;
        static_cast<void>(dN(12, 0) = _m3m9x2m2x * _1pyt1mz),
        static_cast<void>(dN(12, 1) = _1mx2t1m3x * _1mz),
			   dN(12, 2) = -_1mx2t1m3x * _1py;
        static_cast<void>(dN(13, 0) = _p3m9x2m2x * _1pyt1mz),
        static_cast<void>(dN(13, 1) = _1mx2t1p3x * _1mz),
			   dN(13, 2) = -_1mx2t1p3x * _1py;
        static_cast<void>(dN(14, 0) = _m3m9x2m2x * _1pyt1pz),
        static_cast<void>(dN(14, 1) = _1mx2t1m3x * _1pz),
			   dN(14, 2) = _1mx2t1m3x * _1py;
        static_cast<void>(dN(15, 0) = _p3m9x2m2x * _1pyt1pz),
        static_cast<void>(dN(15, 1) = _1mx2t1p3x * _1pz),
        ...
        static_cast<void>(dN(16, 0) = -_1my2t1m3y * _1mz),
        static_cast<void>(dN(16, 1) = _m3m9y2m2y * _1mxt1mz),
			   dN(16, 2) = -_1my2t1m3y * _1mx;
        static_cast<void>(dN(17, 0) = -_1my2t1p3y * _1mz),
        static_cast<void>(dN(17, 1) = _p3m9y2m2y * _1mxt1mz),
			   dN(17, 2) = -_1my2t1p3y * _1mx;
        static_cast<void>(dN(18, 0) = _1my2t1m3y * _1mz),
        static_cast<void>(dN(18, 1) = _m3m9y2m2y * _1pxt1mz),
			   dN(18, 2) = -_1my2t1m3y * _1px;
        static_cast<void>(dN(19, 0) = _1my2t1p3y * _1mz),
        static_cast<void>(dN(19, 1) = _p3m9y2m2y * _1pxt1mz),
			   dN(19, 2) = -_1my2t1p3y * _1px;
        static_cast<void>(dN(20, 0) = -_1my2t1m3y * _1pz),
        static_cast<void>(dN(20, 1) = _m3m9y2m2y * _1mxt1pz),
			   dN(20, 2) = _1my2t1m3y * _1mx;
        static_cast<void>(dN(21, 0) = -_1my2t1p3y * _1pz),
        static_cast<void>(dN(21, 1) = _p3m9y2m2y * _1mxt1pz),
			   dN(21, 2) = _1my2t1p3y * _1mx;
        static_cast<void>(dN(22, 0) = _1my2t1m3y * _1pz),
        static_cast<void>(dN(22, 1) = _m3m9y2m2y * _1pxt1pz),
			   dN(22, 2) = _1my2t1m3y * _1px;
        static_cast<void>(dN(23, 0) = _1my2t1p3y * _1pz),
        static_cast<void>(dN(23, 1) = _p3m9y2m2y * _1pxt1pz),
        ...
        static_cast<void>(dN(24, 0) = -_1mz2t1m3z * _1my),
        static_cast<void>(dN(24, 1) = -_1mz2t1m3z * _1mx),
			   dN(24, 2) = _m3m9z2m2z * _1mxt1my;
        static_cast<void>(dN(25, 0) = -_1mz2t1p3z * _1my),
        static_cast<void>(dN(25, 1) = -_1mz2t1p3z * _1mx),
			   dN(25, 2) = _p3m9z2m2z * _1mxt1my;
        static_cast<void>(dN(26, 0) = -_1mz2t1m3z * _1py),
        static_cast<void>(dN(26, 1) = _1mz2t1m3z * _1mx),
			   dN(26, 2) = _m3m9z2m2z * _1mxt1py;
        static_cast<void>(dN(27, 0) = -_1mz2t1p3z * _1py),
        static_cast<void>(dN(27, 1) = _1mz2t1p3z * _1mx),
			   dN(27, 2) = _p3m9z2m2z * _1mxt1py;
        static_cast<void>(dN(28, 0) = _1mz2t1m3z * _1my),
        static_cast<void>(dN(28, 1) = -_1mz2t1m3z * _1px),
			   dN(28, 2) = _m3m9z2m2z * _1pxt1my;
        static_cast<void>(dN(29, 0) = _1mz2t1p3z * _1my),
        static_cast<void>(dN(29, 1) = -_1mz2t1p3z * _1px),
			   dN(29, 2) = _p3m9z2m2z * _1pxt1my;
        static_cast<void>(dN(30, 0) = _1mz2t1m3z * _1py),
        static_cast<void>(dN(30, 1) = _1mz2t1m3z * _1px),
			   dN(30, 2) = _m3m9z2m2z * _1pxt1py;
        static_cast<void>(dN(31, 0) = _1mz2t1p3z * _1py),
        static_cast<void>(dN(31, 1) = _1mz2t1p3z * _1px),
